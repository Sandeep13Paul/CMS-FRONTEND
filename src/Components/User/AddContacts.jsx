  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/user/contacts/add`,
        formData,
        {
          headers: {
  ...
  useEffect(() => {
    if (messageContact) {
      const timer = setTimeout(() => {
        ...
        setMessageContact(null); // Clear message after a timeout
      }, 1000); // Adjust timeout as needed
  
      return () => clearTimeout(timer); // Clean up timeout on unmount or when `messageContact` changes
    }
  }, [messageContact]);
      ...
      <div className="sm:pl-64 flex flex-col">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-12 md:col-span-6 ">
            <div className="card block mx-8 md:mx-0 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
              <h1 className="text-2xl font-semibold">Add new Contact</h1>
              <p className="text-gray-500 dark:text-gray-400">
                This Contact will be stored on cloud...
              </p>
              {/* Message Box
